...
const FACT_LABELS: Record<string, string> = {
  ...
  rampMultiple: 'Climb',
  rampFromValue: 'Before the climb',
  rampToValue: 'After',
  rampToShare: 'Peak month share',
  quietestValue: 'Quietest month',
  typeAssets: 'Assets of that type',
  typeShareGap: 'Hours vs output gap',
  runnerUpEffortShare: 'Next heaviest',
  squadTaskShare: 'Share of briefs',
  briefSizeRatio: 'Brief size vs others',
  runnerUpShare: 'Next squad',
